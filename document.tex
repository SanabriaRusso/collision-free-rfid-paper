...
The proposed solution dramatically reduces the time required to identify all the tags, specially in a logistics context in which the contents of a pallet are to be read in different locations (e.g., warehouse, truck and shop).
